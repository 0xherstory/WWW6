...
const Index = () => {
  ...
  // 從區塊鏈讀取數據
  const { charityPool, totalVolume, refreshData } = useContract();
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="以金融之息，养万物之壤 - 利用天气预测市场的博弈收益资助农业灾害救助的去中心化应用" />
      </Helmet>
      ...
      <div className="min-h-screen gradient-cream relative z-10">
        ...
        <Navbar
          ...
          charityPoolAmount={parseFloat(charityPool) || 0}
        ...
        <main className="pt-20 pb-8">
          ...
          <section className="container mx-auto px-4 py-8 text-center">
            ...
            <motion.p
              ...
              className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto font-serif"
            >
              <span className="text-primary font-medium">以金融之息</span>
              <span className="mx-2">，</span>
              <span className="text-accent font-medium">养万物之壤</span>
            </motion.p>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
